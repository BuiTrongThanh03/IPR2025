...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btnSave.setToolTip("Save edited image (Ctrl+S)")
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def fix_missing_icons(self):
        icon_paths = [
            ("pushButton", "D:/QT_Designer/IPR_Templated.io-main/Downloads/IPR img/Icons/login.png"),
    ...
    def save_image(self):
        """Lưu ảnh mà không chuyển sang Tkinter."""
        if self.current_image:
            file_dialog = QtWidgets.QFileDialog(self)
    ...
    def resizeEvent(self, event):
        ...
        self.ui.pushButton.setGeometry(QtCore.QRect(content_width - 100, (header_height - 35) // 2, 80, 35))
        ...
        self.ui.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 110, content_width - 40, content_height - 220))
        self.ui.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, content_height - 110, content_width - 40, 50))
        self.ui.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(10, content_height - 60, content_width - 40, 50))
        self.labelPreview.setGeometry(QtCore.QRect(10, 10, content_width - 60, content_height - 240))
        if self.current_image:
            self.display_image()
